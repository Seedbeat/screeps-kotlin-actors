...
import room.planning.RoomTaskKind
import room.planning.RoomWorkAllocator
import room.planning.WorkerSpawnProfile
import screeps.api.Room
import spawn.SpawnCommand
import utils.log.ILogging
import utils.log.LogLevel
import utils.log.Logging

class RoomIntentService<T>(
    api: T
) : ActorApi by api,
    ActorBinding<Room> by api,
    ILogging by Logging.Companion<RoomIntentService<T>>(api.self.name, LogLevel.INFO)
        where T : ActorApi,
              T : ActorBinding<Room> {
